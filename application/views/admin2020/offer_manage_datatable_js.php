    ...
    var TableDatatablesManaged = function () {
        var initTable1 = function () {
            ...
            table.DataTable({
                ...
                "ajax": {
                    url: '<?php echo base_url() . $this->path_to_view_admin ?>offerwall/setDatatableOffer', // json datasource
...
function confirmDelete(frm, product_id)
    {
        with (frm)
        {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    frm.productid.value = product_id;
        ...
        if(ids_arr.length > 0){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url() . $this->path_to_view_admin ?>product/multi_action', // json datasource                    
                        type: 'post',
